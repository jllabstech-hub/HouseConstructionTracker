...
async function main() {
  ...
  // 1. Desktop 1280x900
  console.log("Capturing Desktop Expenses...");
  ...
  await desktopPage.goto("http://localhost:7000/expenses", { waitUntil: "networkidle" });
  await desktopPage.waitForTimeout(2000);

  const desktopPath = path.join(artifactDir, "expenses_redesign_desktop.png");
  ...
  console.log("Capturing Mobile Expenses...");
  ...
  await mobilePage.goto("http://localhost:7000/expenses", { waitUntil: "networkidle" });
  await mobilePage.waitForTimeout(2000);

  const mobilePath = path.join(artifactDir, "expenses_redesign_mobile.png");
