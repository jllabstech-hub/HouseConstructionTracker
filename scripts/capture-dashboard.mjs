...
async function main() {
  ...
  // 1. Desktop 1280x900
  console.log("Capturing Desktop 1280x900...");
  ...
  const desktopPath = path.join(artifactDir, "dashboard_redesign_desktop.png");
  ...
  const mobilePath = path.join(artifactDir, "dashboard_redesign_mobile.png");
